...
export function paddingToTailwind(padding: any): string[] {
  if (!padding) return [];
...
export function radiusToTailwind(radius: any): string {
  if (!radius) return "";
...
export function borderWidthToTailwind(width: number): string {
